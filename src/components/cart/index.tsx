...
import { CartContainer, CartList, CartSummary } from '../../styles/components/cart'
    ...
    return(
        <CartContainer visibility={visibility}>
          ...
          <CartSummary>
            ...
            <button disabled={isCreatingCheckoutSession || items.length == 0} onClick={handleBuyButton}>Fazer Pedido</button>
          </CartSummary>
        </CartContainer>
    )
}